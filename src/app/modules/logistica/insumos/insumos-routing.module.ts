...
import {ImportarInsumosComponent} from "./importar-insumos/importar-insumos.component";
...
@NgModule({
    imports: [
        RouterModule.forChild([
            ...
            { path: 'importar', data: { breadcrumb: 'Importar Insumos' }, component: ImportarInsumosComponent }
        ])
    ],
